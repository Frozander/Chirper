...
Revision ID: 742c66e23b3f
Revises: 
Create Date: 2020-12-25 17:00:42.317258
...
def upgrade():
    ...
    sa.Column('picture', sa.String(length=20), server_default='default.png', nullable=False),
